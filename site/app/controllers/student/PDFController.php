...
class PDFController extends AbstractController {
    ...
    /**
     * @param {string} user_id The student's userid
     * @param {string} gradeable_id The gradeable's id
     * @param {string, optional} instructor_id This field is used if only one annotation is required
     *
     * @return array All the annotations specified in JSON
     */
